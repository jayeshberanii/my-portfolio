            ...
            <div className="md:w-10/12 w-11/12 mx-auto">
                ...
                <div className="w-full md:my-10 tracking-wider">
                    <div className="flex space-x-4 text-xs cursor-pointer justify-center items-center">
                        <Link href="https://github.com/jayeshberanii" target="_blank" className="transition-all duration-500 flex justify-center flex-col items-center">
                        ...
                        <Link href="https://www.instagram.com/jayeshberanii/" target="_blank" className="transition-all duration-500 flex justify-center flex-col items-center">
                        ...
                        <Link href="https://www.linkedin.com/in/jayesh-berani/" target="_blank" className="transition-all duration-500 flex justify-center flex-col items-center">
                        ...
                        <Separator orientation="vertical" className="h-10 flex items-center justify-center mb-4" />
                        <Link href="https://x.com/jayesh_berani" target="_blank" className="transition-all duration-500 flex flex-col">

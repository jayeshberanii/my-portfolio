  ...
  return (
    <>
      <div className="flex justify-between items-center top-0 fixed left-0 right-0 backdrop-blur-md md:max-w-[1460px] w-full mx-auto z-20 md:h-16 h-20 ">
        ...
        <Link href="/">
          {/* <Image width={250} src={logo} alt="no-icon" className=" object-cover ml-3 pt-4 "></Image> */}
          <h3 className="p-4 text-[48px] font-extrabold"><span className="text-[#5eead4]">JAY</span>ESH</h3>
        </Link>

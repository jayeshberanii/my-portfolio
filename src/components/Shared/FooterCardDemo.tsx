  ...
  return (
    <div className="mt-20">
      <div className="w-full mx-auto h-full relative z-10">
          ...
          <div className="grid lg:grid-cols-5 grid-cols-1 w-11/12 mx-auto">
            ...
            <div className="col-span-4 grid lg:grid-cols-3  grid-cols-1 md:justify-start md:items-start justify-center  items-center sm:mb-5 mb-10 ">
              ...
              <div className="flex  flex-col gap-2 justify-center lg:items-start items-center mt-8 lg:mt-0">
                ...
                <Link className="font-light text-neutral-400 text-sm" href="tel:+91 6355353728" >+91 6355353728</Link>
                <Link className="font-light text-neutral-400 text-sm" href="mailto:jayeshberanii@gmail.com" >jayeshberanii@gmail.com</Link>
                <div className="lg:flex hidden mt-5 gap-8 text-neutral-400">

                  <div className="flex gap-4"> <Link target="_blank" href="https://www.linkedin.com/in/jayesh-berani/" className="group">
              ...
              <div className=" lg:hidden flex flex-col gap-2  mt-8 lg:mt-0 items-center ">
                ...
                <div className="flex lg:flex-col gap-8 font-light text-neutral-400">
                  <Link target="_blank" href="https://www.linkedin.com/in/jayesh-berani/"><span className="mr-1 md:inline-flex hidden text-sm">LinkedIn</span><IconBrandLinkedin className="inline" /></Link>
                  <Link target="_blank" href="https://www.instagram.com/jayeshberanii/"><span className="mr-1 md:inline-flex hidden text-sm">Instagram</span><IconBrandInstagram className="inline" /></Link>
                  <Link target="_blank" href="https://github.com/jayeshberanii"><span className="mr-1 md:inline-flex hidden text-sm">Github</span><IconBrandGithub className="inline" /></Link>
                  <Link target="_blank" href="https://x.com/jayesh_berani"><span className="mr-1 md:inline-flex hidden text-sm">Twitter</span><IconBrandX className="inline" /></Link>
                </div>
              </div>
        ...
        <span className="bottom-4  md:bottom-0 my-5 md:my-0 text-xs text-neutral-500 absolute w-full text-center translate-y-10 tracking-widest">{`©Made  With  </>  by  Jayesh.  2024`}</span>
      </div>
    </div>
  );
}
